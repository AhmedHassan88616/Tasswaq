...
import 'package:Tassawaq/Store/product_page.dart';
...
Widget sourceInfo(ItemModel model, BuildContext context,
  ...
  return InkWell(
    onTap: () {
      Route route = MaterialPageRoute(builder: (_) => ProductPage(model));
      Navigator.pushReplacement(context, route);
    },
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  // to complete the cart item remove
...
addItemToCart(String shortInfoAsID, BuildContext context) async {
  ...
  await EcommerceApp.firestore
      ...
      .update({EcommerceApp.userCartList: tempCartList}).then((value) async {
